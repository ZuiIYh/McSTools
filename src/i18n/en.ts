export default {
  ...
  localData: {
    ...
    confirmBatchDeleteBlueprints: 'Are you sure to permanently delete the selected {count} blueprints?',
    deleteSuccess: 'Deleted {count} blueprints',
  ...
  toolsSchematic: {
    ...
    airBlocks: 'Air Blocks',
    clearable: 'Clearable',
    clearAirBlocks: 'Clear Air Blocks',
    clearAirBlocksHint: 'Remove air blocks from the BE schematic and rewrite matching indices to -1',
    confirmClearAirBlocks: 'Confirm that the current schematic contains air blocks before clearing',
    clearAirBlocksSuccess: 'Air blocks cleared',
  ...
  toolsThreeD: {
    ...
    exportObjPackage: 'Export OBJ',
    objExportSelectDirectory: 'Select OBJ package export directory',
    objExporting: 'Exporting OBJ/MTL/textures...',
    objExportCancel: 'Cancel Export',
    objExportCancelled: 'OBJ export cancelled',
    objExportPreparing: 'Preparing export files...',
    objExportGeometryProgress: 'Writing geometry: {built}/{total} chunks, {triangles} triangles, {size} written',
    objExportWritingMaterial: 'Writing material file...',
    objExportWritingTexture: 'Writing texture resources...',
    objExportFinalizing: 'Finalizing export...',
    objExportNoStructure: 'Structure preview is not ready yet',
    objExportEmpty: 'The current structure has no exportable geometry',
    objExportSuccess: 'OBJ/MTL/textures exported successfully ({triangles} triangles)',
    objExportError: 'OBJ package export failed: {error}',
