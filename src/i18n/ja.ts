export default {
  ...
  localData: {
    ...
    batchDelete: '一括削除',
    confirmBatchDeleteBlueprints: '選択した {count} 個の設計図を完全に削除しますか？',
    deleteSuccess: '{count} 個の設計図を削除しました',
  ...
  toolsSchematic: {
    ...
    airBlocks: '空気ブロック',
    clearable: '削除可能',
    clearAirBlocks: '空気ブロックを削除',
    clearAirBlocksHint: 'BE 設計図内の空気ブロックを削除し、対応するインデックスを -1 に書き換えます',
    confirmClearAirBlocks: '削除前に現在の設計図に空気ブロックが含まれていることを確認してください',
    clearAirBlocksSuccess: '空気ブロックの削除が完了しました',
  ...
  toolsThreeD: {
    ...
    exportObjPackage: 'OBJを書き出し',
    objExportSelectDirectory: 'OBJパッケージの書き出し先フォルダーを選択',
    objExporting: 'OBJ/MTL/テクスチャを書き出しています...',
    objExportCancel: '書き出しをキャンセル',
    objExportCancelled: 'OBJ書き出しをキャンセルしました',
    objExportPreparing: '書き出しファイルを準備しています...',
    objExportGeometryProgress: 'ジオメトリを書き込み中: {built}/{total} チャンク、{triangles} 三角形、{size} 書き込み済み',
    objExportWritingMaterial: 'マテリアルファイルを書き込み中...',
    objExportWritingTexture: 'テクスチャリソースを書き込み中...',
    objExportFinalizing: '書き出しを完了しています...',
    objExportNoStructure: '構造プレビューの準備ができていません',
    objExportEmpty: '現在の構造には書き出し可能なジオメトリがありません',
    objExportSuccess: 'OBJ/MTL/テクスチャを書き出しました（{triangles} 三角形）',
    objExportError: 'OBJパッケージの書き出しに失敗: {error}',
  ...
  modloader: {
    ...
    compatNote: 'MOD互換性は改善途上です。初期パフォーマンスは低めです。',
    note: 'アンインストールはブロックとキャッシュを完全に削除します。無効化は一時的に非表示にするだけで、いつでも再有効化できます。エディタ镜像を差し替えても有効なMODは自動で再読み込みされます。',
    previewFailed: 'このファイルを読み込めません',
    uninstallDialog: {
      title: 'MODをアンインストール',
      message: '{name} をアンインストールしますか？',
      hint: 'ブロック・アトラスの占有・キャッシュが完全に削除されます。復元するには jar ファイルを再度選択してください。',
      cancel: 'キャンセル',
      confirm: 'アンインストール'
    }
  }
