  ...
  [3127],
  {
    4195: (e, t, r) => {
      ...
      function n() {
        return (function (e) {
          function t(e, t) {
            for (var r, n, a, i, o, l = /([MLQCZ])([^MLQCZ]*)/g; (r = l.exec(e));) {
              var s = r[2]
                .replace(/^\s*|\s*$/g, "")
                .split(/[,\s]+/)
                .map(function (e) {
              ...
              switch (r[1]) {
                case "M":
                  ...
                  break;
                case "L":
                  (s[0] !== i || s[1] !== o) && t("L", i, o, (i = s[0]), (o = s[1]));
                  break;
                case "Q":
          ...
          function r(e, r, n) {
            void 0 === n && (n = 16);
            var a = { x: 0, y: 0 };
            t(e, function (e, t, i, o, l, s, f, c, u) {
              switch (e) {
                case "L":
                  r(t, i, o, l);
                  break;
                case "Q":
                  for (var v = t, d = i, h = 1; h < n; h++)
                  ...
                  break;
                case "C":
                  for (var g = t, p = i, m = 1; m < n; m++)
                    (!(function (e, t, r, n, a, i, o, l, s, f) {
                      var c = 1 - s;
                      ((f.x =
                        c * c * c * e + 3 * c * c * s * r + 3 * c * s * s * a + s * s * s * o),
                        (f.y =
                          c * c * c * t + 3 * c * c * s * n + 3 * c * s * s * i + s * s * s * l));
                    })(t, i, s, f, c, u, o, l, m / (n - 1), a),
                      r(g, p, a.x, a.y),
                      (g = a.x),
                      (p = a.y));
              }
          ...
          function o(e, t) {
            ...
            if (!n) {
              ...
              function v(e) {
                var t = l[e];
                if (!t && !(t = l[e] = r.getExtension(e))) throw Error(e + " not supported");
                return t;
              }
              function d(e, t) {
                    ...
                    withProgram: function (e, t, n, a) {
                      if (!s[e]) {
                        var i = {},
                          l = {},
                          f = r.createProgram();
                        (r.attachShader(f, d(t, r.VERTEX_SHADER)),
                          r.attachShader(f, d(n, r.FRAGMENT_SHADER)),
                          r.linkProgram(f),
                          (s[e] = {
                            program: f,
                                ...
                                e({
                                  setUniform: function (e, t) {
                                    for (var n = [], a = arguments.length - 2; a-- > 0;)
                                      n[a] = arguments[a + 2];
                                    var i = l[t] || (l[t] = r.getUniformLocation(f, t));
                                  ...
                                  setAttribute: function (e, t, n, a, l) {
                                    ...
                                    (s ||
                                      (s = i[e] =
                                        {
                                          buf: r.createBuffer(),
                                          loc: r.getAttribLocation(f, e),
                                          data: null,
                                        }),
                                      r.bindBuffer(r.ARRAY_BUFFER, s.buf),
                                      r.vertexAttribPointer(s.loc, t, r.FLOAT, !1, 0, 0),
                                      r.enableVertexAttribArray(s.loc),
                                      o
                                        ? r.vertexAttribDivisor(s.loc, a)
                                        : v("ANGLE_instanced_arrays").vertexAttribDivisorANGLE(
                                            s.loc,
                                            a,
                                          ),
                                      l !== s.data &&
                                        (r.bufferData(r.ARRAY_BUFFER, l, n), (s.data = l)));
                                  },
                                }));
                            },
                          }));
                    ...
                    withTextureFramebuffer: function (e, t, n) {
                      ...
                      try {
                        ...
                        (r.deleteFramebuffer(a),
                          r.bindFramebuffer(r.FRAMEBUFFER, u[--u.length - 1] || null));
                      }
                    },
                    handleContextLoss: h,
                  }),
            ...
            (void 0 === s && (s = 15),
              ...
              o(e, function (e) {
                ...
                (0, e.withTexture)("copy", function (e, u) {
                  (o.texImage2D(o.TEXTURE_2D, 0, o.RGBA, i, l, 0, o.RGBA, o.UNSIGNED_BYTE, t),
                    c(
                      "copy",
                      n,
                      ...
                      function (e) {
                        ...
                        ((0, e.setAttribute)(
                          ...
                          t("1i", "image", u),
                          o.bindFramebuffer(o.FRAMEBUFFER, f || null),
                          o.disable(o.BLEND),
            ...
            for (var u = 0; u < e; u++)
              for (var v = 0; v < t; v++) {
                var d = (function (e, t) {
                      ...
                      if (e + n > i.minX && t - n < i.maxY && t + n > i.minY) {
                        var o = (function (e, t, r, n, a, i) {
                          var o = a - r,
                            l = i - n,
                            s = o * o + l * l,
                            f = s ? Math.max(0, Math.min(1, ((e - r) * o + (t - n) * l) / s)) : 0,
                            c = e - (r + f * o),
                            u = t - (n + f * l);
                          return c * c + u * u;
                  ...
                  })(a[0] + (s * (u + 0.5)) / e, a[1] + (f * (v + 0.5)) / t),
                  h = Math.pow(1 - Math.abs(d) / i, o) / 2;
                (d < 0 && (h = 1 - h),
                  (h = Math.max(0, Math.min(255, Math.round(255 * h)))),
                  (l[v * e + u] = h));
              }
            return l;
          }
          function c(e, t, r, n, a, i, o, l, s, f) {
            (void 0 === i && (i = 1),
              void 0 === l && (l = 0),
              void 0 === s && (s = 0),
              void 0 === f && (f = 0),
              u(e, t, r, n, a, i, o, null, l, s, f));
          }
          function u(e, t, r, n, a, i, o, s, c, u, v) {
            (void 0 === i && (i = 1),
              void 0 === c && (c = 0),
              void 0 === u && (u = 0),
              void 0 === v && (v = 0));
            for (
              var d = f(e, t, r, n, a, i), h = new Uint8Array(4 * d.length), g = 0;
              g < d.length;
              g++
            )
              h[4 * g + v] = d[g];
            l(o, h, c, u, e, t, 1 << (3 - v), s);
          }
          var v = Object.freeze({
              __proto__: null,
              generate: f,
            ...
            m = new WeakMap();
          function b(e) {
            if (!g && !x(e)) throw Error("WebGL generation not supported");
          }
          function y(e, t, r, n, a, i, l) {
            if ((void 0 === i && (i = 1), void 0 === l && (l = null), !l && !(l = h))) {
              var s =
              ...
              l = h = s.getContext("webgl", { depth: !1 });
            }
            b(l);
            var f = new Uint8Array(e * t * 4);
            o(l, function (o) {
              var l = o.gl,
                s = o.withTexture,
                c = o.withTextureFramebuffer;
              s("readable", function (o, s) {
                (l.texImage2D(l.TEXTURE_2D, 0, l.RGBA, e, t, 0, l.RGBA, l.UNSIGNED_BYTE, null),
                  c(o, s, function (o) {
                    (w(e, t, r, n, a, i, l, o, 0, 0, 0),
                      l.readPixels(0, 0, e, t, l.RGBA, l.UNSIGNED_BYTE, f));
                  }));
              });
            });
            for (var c = new Uint8Array(e * t), u = 0, v = 0; u < f.length; u += 4) c[v++] = f[u];
            return c;
          }
          function _(e, t, r, n, a, i, o, l, s, f) {
            (void 0 === i && (i = 1),
              void 0 === l && (l = 0),
              void 0 === s && (s = 0),
              void 0 === f && (f = 0),
              w(e, t, r, n, a, i, o, null, l, s, f));
          }
          function w(e, t, a, i, l, s, f, c, u, v, h) {
            (void 0 === s && (s = 1),
              void 0 === u && (u = 0),
              void 0 === v && (v = 0),
              void 0 === h && (h = 0),
            ...
            (r(a, function (e, t, r, n) {
              ...
              o(f, function (r) {
                var a = r.gl,
                  ...
                  p = r.withProgram,
                  m = r.withTexture,
                  b = r.withTextureFramebuffer,
                  y = r.handleContextLoss;
                if (
                      ...
                      p(
                        ...
                        function (n) {
                          var c = n.setAttribute,
                            u = n.setUniform,
                            v = !o && f("ANGLE_instanced_arrays"),
                            h = !o && f("EXT_blend_minmax");
                          (c("aUV", 2, a.STATIC_DRAW, 0, d),
                            c("aLineSegment", 4, a.DYNAMIC_DRAW, 1, g),
                            u.apply(void 0, ["4f", "uGlyphBounds"].concat(i)),
                            u("1f", "uMaxDistance", l),
                            u("1f", "uExponent", s),
                            b(r, m, function (r) {
                              (a.enable(a.BLEND),
                                ...
                                a.blendEquationSeparate(a.FUNC_ADD, o ? a.MAX : h.MAX_EXT),
                                a.clear(a.COLOR_BUFFER_BIT),
                                o
                                  ? a.drawArraysInstanced(a.TRIANGLES, 0, 3, g.length / 4)
                                  : v.drawArraysInstancedANGLE(a.TRIANGLES, 0, 3, g.length / 4));
                            }));
                        },
                      ),
                      p(
                        ...
                        function (r) {
                          (r.setAttribute("aUV", 2, a.STATIC_DRAW, 0, d),
                  ...
                  throw (y(), Error("webgl context lost"));
              }));
          }
          function x(e) {
            var t = e && e !== h ? e.canvas || e : p,
              r = m.get(t);
            if (void 0 === r) {
              g = !0;
              var n = null;
              try {
                var a = [97, 106, 97, 61, 99, 137, 118, 80, 80, 118, 137, 99, 61, 97, 106, 97],
                  i = y(4, 4, "M8,8L16,8L24,24L16,24Z", [0, 0, 32, 32], 24, 1, e);
                (r =
                  i &&
                  a.length === i.length &&
              ...
              (n && console.warn("WebGL SDF generation not supported:", n), (g = !1), m.set(t, r));
            }
            return r;
          }
          var E = Object.freeze({
          ...
          return (
            ...
            (e.generateIntoCanvas = function (e, t, r, n, a, i, o, l, s, f) {
              (void 0 === a && (a = Math.max(n[2] - n[0], n[3] - n[1]) / 2),
                void 0 === i && (i = 1),
                void 0 === l && (l = 0),
                void 0 === s && (s = 0),
    ...
    17509: (e, t, r) => {
      ...
      let n = function () {
        return (function (e) {
                ...
                if (i.hasOwnProperty(e)) {
                  ...
                  i[e].split(",").forEach(function (r) {
                    var n = r.split("+"),
                      a = n[0],
                      i = n[1];
                    ((a = parseInt(a, 36)), (i = i ? parseInt(i, 36) : 0), d.set((t += a), o[e]));
                    for (var l = 0; l < i; l++) d.set(++t, o[e]);
                  });
                }
              };
              for (var r in i) t(r);
            }
            return d.get(e.codePointAt(0)) || o.L;
          }
          function g(e, t) {
            var r,
              n = 0,
          ...
          function m(e) {
            return (p(), t.get(e) || null);
          }
          function b(e) {
            return (p(), r.get(e) || null);
          }
          function y(e) {
            return (p(), n.get(e) || null);
          }
          var _ = o.L,
            w = o.R,
            x = o.EN,
            ...
            return (
              t.paragraphs.forEach(function (a) {
                var o = Math.max(r, a.start),
                  l = Math.min(n, a.end);
                if (o < l) {
                  for (var s = t.levels.slice(o, l + 1), f = l; f >= o && h(e[f]) & v; f--)
                    s[f] = a.level;
                  for (var c = a.level, u = 1 / 0, d = 0; d < s.length; d++) {
                    var g = s[d];
                    (g > c && (c = g), g < u && (u = 1 | g));
                  }
                  for (var p = c; p >= u; p--)
                    for (var m = 0; m < s.length; m++)
                      if (s[m] >= p) {
                        for (var b = m; m + 1 < s.length && s[m + 1] >= p;) m++;
                        m > b && i.push([b + o, m + o]);
                      }
                }
              }),
          ...
          function W(e, t, r, n) {
            for (var a = q(e, t, r, n), i = [], o = 0; o < e.length; o++) i[o] = o;
            return (
              a.forEach(function (e) {
                for (var t = e[0], r = e[1], n = i.slice(t, r + 1), a = n.length; a--;)
                  i[r - a] = n[a];
              }),
              i
            );
          ...
          return (
            ...
            (e.getEmbeddingLevels = function (e, t) {
              for (var r = new Uint32Array(e.length), n = 0; n < e.length; n++) r[n] = h(e[n]);
              var a = new Map();
              function i(e, t) {
                var n = r[e];
                ((r[e] = t),
              ...
              for (
                var o = new Uint8Array(e.length), l = new Map(), d = [], g = null, p = 0;
                p < e.length;
                p++
              )
                (g ||
                  d.push(
                    (g = {
                      ...
                      level: "rtl" === t ? 1 : "ltr" === t ? 0 : tL(p, !1),
                    }),
                  ),
                  r[p] & A && ((g.end = p), (g = null)));
              for (
                var G = j | C | U | B | s | z | F | A,
                  q = function (e) {
                    return e + (1 & e ? 1 : 2);
                  },
                  W = function (e) {
                ...
                var X = [{ _level: (g = d[$]).level, _override: 0, _isolate: 0 }],
                  V = void 0,
                  Y = 0,
                  H = 0,
                  K = 0;
                a.clear();
                for (var Q = g.start; Q <= g.end; Q++) {
                  var Z = r[Q];
                  if (
                    ((V = X[X.length - 1]),
                    a.set(Z, (a.get(Z) || 0) + 1),
                    Z & c && a.set(c, (a.get(c) || 0) + 1),
                    Z & G)
                  )
                    if (Z & (j | C)) {
                      o[Q] = V._level;
                      var J = (Z === j ? W : q)(V._level);
                      !(J <= 125) || Y || H
                        ? !Y && H++
                        : X.push({ _level: J, _override: 0, _isolate: 0 });
                    } else if (Z & (U | B)) {
                      o[Q] = V._level;
                      var ee = (Z === U ? W : q)(V._level);
                      !(ee <= 125) || Y || H
                        ? !Y && H++
                        : X.push({ _level: ee, _override: Z & U ? w : _, _isolate: 0 });
                    } else if (Z & s) {
                      (Z & O && (Z = 1 === tL(Q + 1, !0) ? N : P),
                        (o[Q] = V._level),
                        V._override && i(Q, V._override));
                      var et = (Z === N ? W : q)(V._level);
                      et <= 125 && 0 === Y && 0 === H
                        ? (K++,
                          X.push({ _level: et, _override: 0, _isolate: 1, _isolInitIndex: Q }))
                        : Y++;
                    } else if (Z & z) {
                      if (Y > 0) Y--;
                      else if (K > 0) {
                        for (H = 0; !X[X.length - 1]._isolate;) X.pop();
                        var er = X[X.length - 1]._isolInitIndex;
                        (null != er && (l.set(er, Q), l.set(Q, er)), X.pop(), K--);
                      }
                      ((V = X[X.length - 1]), (o[Q] = V._level), V._override && i(Q, V._override));
                    } else
                      Z & F
                        ? (0 === Y &&
                            (H > 0
                              ? H--
                              : !V._isolate && X.length > 1 && (X.pop(), (V = X[X.length - 1]))),
                          (o[Q] = V._level))
                        : Z & A && (o[Q] = g.level);
                  else ((o[Q] = V._level), V._override && Z !== L && i(Q, V._override));
                }
                for (var en = [], ea = null, ei = g.start; ei <= g.end; ei++) {
                  var eo = r[ei];
                  if (!(eo & u)) {
                    var el = o[ei],
                      es = eo & s,
                ...
                for (var ec = [], eu = 0; eu < en.length; eu++) {
                  var ev = en[eu];
                  if (!ev._startsWithPDI || (ev._startsWithPDI && !l.has(ev._start))) {
                    for (
                      var ed = [(ea = ev)], eh = void 0;
                      ea && ea._endsWithIsolInit && null != (eh = l.get(ea._end));
                    )
                      for (var eg = eu + 1; eg < en.length; eg++)
                        if (en[eg]._start === eh) {
                          ed.push((ea = en[eg]));
                          break;
                        }
                    for (var ep = [], em = 0; em < ed.length; em++)
                      for (var eb = ed[em], ey = eb._start; ey <= eb._end; ey++) ep.push(ey);
                    for (var e_ = o[ep[0]], ew = g.level, ex = ep[0] - 1; ex >= 0; ex--)
                      if (!(r[ex] & u)) {
                        ew = o[ex];
                        break;
                      }
                    var eE = ep[ep.length - 1],
                      eM = o[eE],
                      ek = g.level;
                    if (!(r[eE] & s)) {
                      for (var eT = eE + 1; eT <= g.end; eT++)
                        if (!(r[eT] & u)) {
                          ek = o[eT];
                          break;
                        }
                    ...
                    ec.push({
                      _seqIndices: ep,
                      _sosType: Math.max(ew, e_) % 2 ? w : _,
                      _eosType: Math.max(ek, eM) % 2 ? w : _,
                    });
                  }
                }
                for (var eA = 0; eA < ec.length; eA++) {
                  var eD = ec[eA],
                    eR = eD._seqIndices,
                    eL = eD._sosType,
                    eI = eD._eosType,
                    eS = 1 & o[eR[0]] ? w : _;
                  if (a.get(I))
                    for (var eB = 0; eB < eR.length; eB++) {
                      var eU = eR[eB];
                      if (r[eU] & I) {
                        for (var eC = eL, ej = eB - 1; ej >= 0; ej--)
                          if (!(r[eR[ej]] & u)) {
                            eC = r[eR[ej]];
                            break;
                          }
                  ...
                  if (a.get(x))
                    for (var eF = 0; eF < eR.length; eF++) {
                      var eP = eR[eF];
                      if (r[eP] & x)
                        for (var eN = eF - 1; eN >= -1; eN--) {
                          var eO = -1 === eN ? eL : r[eR[eN]];
                          if (eO & f) {
                            eO === S && i(eP, k);
                            break;
                          }
                  ...
                  if (a.get(S))
                    for (var ez = 0; ez < eR.length; ez++) {
                      var eG = eR[ez];
                      r[eG] & S && i(eG, w);
                    }
                  if (a.get(E) || a.get(T))
                    for (var eq = 1; eq < eR.length - 1; eq++) {
                      var eW = eR[eq];
                      if (r[eW] & (E | T)) {
                        for (
                          var e$ = 0, eX = 0, eV = eq - 1;
                          eV >= 0 && (e$ = r[eR[eV]]) & u;
                          eV--
                        );
                        for (var eY = eq + 1; eY < eR.length && (eX = r[eR[eY]]) & u; eY++);
                        e$ === eX && (r[eW] === E ? e$ === x : e$ & (x | k)) && i(eW, e$);
                      }
                    }
                  if (a.get(x)) {
                    for (var eH = 0; eH < eR.length; eH++)
                      if (r[eR[eH]] & x) {
                        for (var eK = eH - 1; eK >= 0 && r[eR[eK]] & (M | u); eK--) i(eR[eK], x);
                        for (eH++; eH < eR.length && r[eR[eH]] & (M | u | x); eH++)
                          r[eR[eH]] !== x && i(eR[eH], x);
                      }
                  }
                  if (a.get(M) || a.get(E) || a.get(T))
                    for (var eQ = 0; eQ < eR.length; eQ++) {
                      var eZ = eR[eQ];
                      if (r[eZ] & (M | E | T)) {
                        i(eZ, R);
                        for (var eJ = eQ - 1; eJ >= 0 && r[eR[eJ]] & u; eJ--) i(eR[eJ], R);
                        for (var e1 = eQ + 1; e1 < eR.length && r[eR[e1]] & u; e1++) i(eR[e1], R);
                      }
                    }
                  if (a.get(x))
                    for (var e2 = 0, e0 = eL; e2 < eR.length; e2++) {
                      var e3 = eR[e2],
                        e5 = r[e3];
                      e5 & x ? e0 === _ && i(e3, _) : e5 & f && (e0 = e5);
                    }
                  if (a.get(c)) {
                    for (
                      var e4 = w | x | k, e6 = e4 | _, e7 = [], e8 = [], e9 = 0;
                      e9 < eR.length;
                      e9++
                    )
                      if (r[eR[e9]] & c) {
                        var te = e[eR[e9]],
                          tt = void 0;
                        if (null !== m(te))
                          if (e8.length < 63) e8.push({ char: te, seqIndex: e9 });
                          else break;
                        else if (null !== (tt = b(te)))
                          for (var tr = e8.length - 1; tr >= 0; tr--) {
                            var tn = e8[tr].char;
                            if (tn === tt || tn === b(y(te)) || m(y(tn)) === te) {
                              (e7.push([e8[tr].seqIndex, e9]), (e8.length = tr));
                              break;
                            }
                          }
                      }
                    e7.sort(function (e, t) {
                      return e[0] - t[0];
                    });
                    for (var ta = 0; ta < e7.length; ta++) {
                      for (
                        var ti = e7[ta], to = ti[0], tl = ti[1], ts = !1, tf = 0, tc = to + 1;
                        tc < tl;
                        tc++
                      ) {
                        var tu = eR[tc];
                      ...
                      if (tf) {
                        if (((r[eR[to]] = r[eR[tl]] = tf), tf !== eS)) {
                          for (var tp = to + 1; tp < eR.length; tp++)
                            if (!(r[eR[tp]] & u)) {
                              h(e[eR[tp]]) & I && (r[eR[tp]] = tf);
                              break;
                            }
                        }
                        if (tf !== eS) {
                          for (var tm = tl + 1; tm < eR.length; tm++)
                            if (!(r[eR[tm]] & u)) {
                              h(e[eR[tm]]) & I && (r[eR[tm]] = tf);
                              break;
                            }
                        }
                      }
                    }
                    for (var tb = 0; tb < eR.length; tb++)
                      if (r[eR[tb]] & c) {
                        for (var ty = tb, t_ = tb, tw = eL, tx = tb - 1; tx >= 0; tx--)
                          if (r[eR[tx]] & u) ty = tx;
                          else {
                            tw = r[eR[tx]] & e4 ? w : _;
                            break;
                          }
                        for (var tE = eI, tM = tb + 1; tM < eR.length; tM++)
                          if (r[eR[tM]] & (c | u)) t_ = tM;
                          else {
                            tE = r[eR[tM]] & e4 ? w : _;
                            break;
                          }
                        for (var tk = ty; tk <= t_; tk++) r[eR[tk]] = tw === tE ? tw : eS;
                        tb = t_;
                      }
                  }
                }
                for (var tT = g.start; tT <= g.end; tT++) {
                  var tA = o[tT],
                    tD = r[tT];
                  if (
                    (1 & tA
                      ...
                      : tD & w
                        ? o[tT]++
                        : tD & (k | x) && (o[tT] += 2),
                    tD & u && (o[tT] = 0 === tT ? g.level : o[tT - 1]),
                    tT === g.end || h(e[tT]) & (D | A))
                  )
                    for (var tR = tT; tR >= 0 && h(e[tR]) & v; tR--) o[tR] = g.level;
                }
              }
              return { levels: o, paragraphs: d };
              function tL(t, n) {
                for (var a = t; a < e.length; a++) {
                  var i = r[a];
                  if (i & (w | S)) return 1;
                  if (i & (A | _) || (n && i === z)) break;
                  if (i & s) {
                    var o = (function (t) {
            ...
            (e.getReorderedString = function (e, t, r, n) {
              ...
              return (
                a.forEach(function (r, n) {
                  i[n] = (1 & t.levels[r] ? G(e[r]) : null) || e[r];
                }),
                i.join("")
              );
            }),
            (e.openingToClosingBracket = m),
            Object.defineProperty(e, "__esModule", { value: !0 }),
            e
          );
        })({});
    ...
    37771: (e, t, r) => {
      ...
      let l = [];
      for (let e = 0; e < 256; e++) l[e] = (e < 16 ? "0" : "") + e.toString(16);
      let s =
          Object.assign ||
          function () {
            let e = arguments[0];
      ...
      function d(e, t) {
        let r = (function (e) {
            let t = JSON.stringify(e, g),
              r = m.get(t);
            return (null == r && m.set(t, (r = ++p)), r);
          })(t),
          n = c.get(e);
        if ((n || c.set(e, (n = Object.create(null))), n[r])) return new n[r]();
        let i = `_onBeforeCompile${r}`,
          b = function (n, a) {
            e.onBeforeCompile.call(this, n, a);
            let l = this.customProgramCacheKey() + "|" + n.vertexShader + "|" + n.fragmentShader,
              c = u[l];
            if (!c) {
              let e = (function (e, { vertexShader: t, fragmentShader: r }, n, a) {
                let {
                  vertexDefs: i,
                  vertexMainIntro: l,
                  vertexMainOutro: s,
                ...
                if (
                  ...
                  let e = g({ vertexShader: t, fragmentShader: r });
...
`),
                  ...
                  { vertexShader: (t = h(t, a, i, l, s)), fragmentShader: (r = h(r, a, c, u, v)) }
                );
              })(this, n, t, r);
              c = u[l] = e;
            }
          ...
          y = function () {
            return _(t.chained ? e : e.clone());
          },
          _ = function (n) {
            let a = Object.create(n, w);
            return (
              Object.defineProperty(a, "baseMaterial", { value: e }),
              Object.defineProperty(a, "id", { value: v++ }),
              (a.uuid = (function () {
              ...
              (a.uniforms = s({}, n.uniforms, t.uniforms)),
              (a.defines = s({}, n.defines, t.defines)),
              (a.defines[`TROIKA_DERIVED_MATERIAL_${r}`] = ""),
              (a.extensions = s({}, n.extensions, t.extensions)),
              (a._listeners = void 0),
              a
            );
          },
          w = {
            ...
            copy: {
              ...
              value: function (t) {
                return (
                  ...
                  e.isShaderMaterial ||
                    e.isDerivedMaterial ||
                    (s(this.extensions, t.extensions),
                    s(this.defines, t.defines),
                    s(this.uniforms, a.LlO.clone(t.uniforms))),
                  this
                );
              },
            },
            clone: {
              ...
              configurable: !0,
              value: function () {
                return _(new e.constructor()).copy(this);
              },
            },
            getDepthMaterial: {
              writable: !0,
                ...
                return (
                  r ||
                    (((r = this._distanceMaterial =
                      d(
                        e.isDerivedMaterial ? e.getDistanceMaterial() : new a.aVO(),
                        t,
...
`,
        x = null,
        E = new a._4j({ color: 0xffffff, side: a.$EB });
      class M extends a.eaF {
        static getGeometry() {
          return x || (x = new a.Ho_(1, 1, 1, 6, 64).translate(0, 0.5, 0));
        }
        constructor() {
          (super(M.getGeometry(), E),
            (this.pointA = new a.Pq0()),
            (this.controlA = new a.Pq0()),
            (this.controlB = new a.Pq0()),
            (this.pointB = new a.Pq0()),
            (this.radius = 0.01),
            (this.dashArray = new a.I9Y()),
            (this.dashOffset = 0),
            ...
            (e && e.baseMaterial === t) ||
              ((e = this._derivedMaterial =
                d(t, {
                  chained: !0,
                  uniforms: {
                    pointA: { value: new a.Pq0() },
                    controlA: { value: new a.Pq0() },
                    controlB: { value: new a.Pq0() },
                    pointB: { value: new a.Pq0() },
                    radius: { value: 0.01 },
                    dashing: { value: new a.Pq0() },
                  },
                  vertexDefs: b,
                  vertexTransform: y,
                  fragmentDefs: _,
        ...
        onBeforeRender() {
          ...
          (e.pointA.value.copy(t),
            ...
            e.pointB.value.copy(a),
            (e.radius.value = i),
            e.dashing.value.set(o.x, o.y, l || 0));
        }
        raycast() {}
      }
    },
    46923: (e, t, r) => {
      ...
      let s = a.forwardRef(
        (
          ...
          let g = (0, o.C)(({ invalidate: e }) => e),
            [p] = a.useState(() => new i.EY()),
            [m, b] = a.useMemo(() => {
              let e = [],
                t = "";
              return (
          ...
          return (
            (0, l.DY)(
              () => new Promise((e) => (0, i.PY)({ font: s, characters: u }, e)),
              ["troika-text", s, u],
            ),
            a.useLayoutEffect(
              () =>
                ...
                if ((void 0 === f && (f = null), !e[i]))
                  try {
                    ((l = l.map(function (t) {
                      ...
                      (s = t("<" + o + ">.init", s)),
                      f && (f = t("<" + o + ">.getTransferables", f)));
                    var c = null;
                    ("function" == typeof s
                      ? (c = s.apply(void 0, l))
                      : console.error("worker module init function failed to rehydrate"),
                      (e[i] = { id: i, value: c, getTransferables: f }),
                      a(c));
                  } catch (e) {
          ...
          function e(t) {
            ...
            var r,
              ...
              u =
                ...
                r);
            null == c && (c = "#default");
            var h = "workerModule" + ++i,
              g = t.name || h,
              p = null;
            function m() {
              for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
              if (!a()) return u.apply(void 0, e);
              if (!p) {
                p = d(c, "registerModule", m.workerModuleData);
                var r = function () {
                  ((p = null), f[c].delete(r));
                };
                (f[c] || (f[c] = new Set())).add(r);
              }
              return p.then(function (t) {
                if (t.isCallable) return d(c, "callModule", { id: h, args: e });
                throw Error(
                  "Worker module function was called but `init` did not return a callable function",
                );
              });
                ...
                n.map(function (t) {
                  return (
                    "function" != typeof t ||
                      ...
                      (t = e({
                        workerId: c,
                        name: "<" + g + "> function dependency: " + t.name,
              ...
              if (!t) {
                ...
                (t = s[e] =
                  ...
                  var t = e.data,
                    r = t.messageId,
                    n = c[r];
                  if (!n) throw Error("WorkerModule response with empty or unknown messageId");
                  (delete c[r], n(t));
                };
              }
              return t;
